  ...
  const mainFAQData = [
    {
      ...
      content:
        'A. 모던 애자일 7기 모집은 23년 11월 8일(수)부터 11월 17일(금)까지 지원 접수를 받고 있습니다. 20일부터는 면접 또는 간단한 테스트 전형을 진행 할 예정입니다. (일정 또는 과정은 달라질 수 있습니다.)\n\n부담 가지 실 필요 없이 개발에 대한 열정과 모던 애자일과의 FIT이 잘 맞는지를 최우선적으로 판단 할 예정입니다.',
    },
    {
      id: 2,
    ...
    },
    {
      ...
      content:
        'A. 현재 6기의 회비는 1만원 입니다. 하지만 7기 활동이 시작되면 7기 인원이 필요에 기반하여 자율적으로 책정하고 관리하게 됩니다.',
    },
    {
      id: 5,
