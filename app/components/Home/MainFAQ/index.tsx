  ...
  const mainFAQData = [
    {
      ...
      content:
        'A. 모던 애자일 11기 모집은 25년 10월 31일(금)부터 12월 05일(금)까지 지원 접수를 받고 있습니다. 07일(월)부터는 면접 및 간단한 테스트 전형을 진행 할 예정입니다. (일정 또는 과정은 달라질 수 있습니다.)\n\n부담 가지 실 필요 없이 개발에 대한 열정과 모던 애자일과의 FIT이 잘 맞는지를 최우선적으로 판단 할 예정입니다. 또한, 추가 모집 일정이 생길 수 있습니다.',
    },
    {
      id: 2,
      title: 'Q. 합격 발표 일정은 어떻게 되나요?',
      content: 'A. 모던 애자일 11기 합격 발표는 12월 13일(토) 입니다.',
    },
    {
      id: 3,
    ...
    },
    {
      ...
      content:
        'A. 현재 10기의 회비는 1만원 입니다. 11기 활동이 시작되면 11기 분들이 자율적으로 책정하고 관리하게 됩니다.',
    },
    {
      id: 6,
